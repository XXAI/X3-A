...
class InicializarInventarioMedicamentosController extends Controller
{
 ...
 ///****************************************************************************************************************************************
        ...
        $inicializacion = InicializacionInventario::where('almacen_id',$parametros['almacen'])->first();
        ...
        if($inicializacion)
        {
            ...
            //$data = array("status" => 200,"messages" => "Operación realizada con exito", "data" => $inicializacion);
            //return Response::make(json_encode($data, JSON_NUMERIC_CHECK),200,['Content-Type' => 'application/json']);

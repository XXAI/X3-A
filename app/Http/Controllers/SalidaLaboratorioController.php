...
*
*/
class SalidaLaboratorioController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $movimientos = DB::table("movimientos AS mov")
                             ...
                             ->where('mov.tipo_movimiento_id',14)
...
///***************************************************************************************************************************
    ...
    { 
        ...
        $reglas = array();
        $reglas = [
                    'tipo_movimiento_id' => 'required|integer|in:13,14',
                  ];
